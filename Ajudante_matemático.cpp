...
{
    int menu = 1, n1, n2, r1, r2, pontos = 0, cont, vezes = 1; 
    float a, b, c, x1, x2, igualdade, delta;
    printf("\n\t\t- Ajudante matematico -\n");
	while (opcao != 0)
    	{
			printf("\n	Qual serah o assunto que serah abordado?\n\n");
    		...
    		if (opcao == 1) 
				...
				do 
					{
						printf("\n\tDigite 1 se quiser fazer de novo\n\tDigite 0 se quiser voltar para o menu: ") scanf("%d", &menu);
	...
	printf("\n\tMuito obrigado por usar a minha ferrmaneta! Aceito sugestoes para melhoria!\n\n");
}
