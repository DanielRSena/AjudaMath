...
class ExerciMath {
    ...
    static int pontos = 0;
    static boolean erroFatal = false;
    static Scanner entrada = new Scanner(System.in, "latin1");

    //1.    Funções gerais

    static String messageErro() {
        entrada.close();
        return "\nErro! Apenas números são aceitos\nLembre-se de que os decimais devem ser representados por vírgula";
    }
    ...
    static int equa2() {
        ...
        try {
            ...
            if (delta == respostaDelta) System.out.println(acerto());
        ...
        if (erroFatal == false) {
            ...
            if (delta > 0) {
                ...
                try {
                    ...
                    if (x1 == respostaX1) System.out.println(acerto());
    ...
    double nx1 = random.nextInt(10) + 1; 
    double ny1 = random.nextInt(10) + 1; 
    double n1 = random.nextInt(10) + 1; 
    double nx2 = random.nextInt(10) + 1; 
    double ny2 = random.nextInt(10) + 1; 
    double n2 = random.nextInt(10) + 1; 
	...
	y = n2 / ny2;
    BigDecimal res = BigDecimal.valueOf(y).setScale(2, RoundingMode.HALF_UP);
    y = res.doubleValue();

	x = (aux2 - (aux * y)) / nx1;
    res = BigDecimal.valueOf(x).setScale(2, RoundingMode.HALF_UP);
    x = res.doubleValue();
    ...
    static int tabuada(){
       ...
       if (erroFatal == false) {
         while ((System.currentTimeMillis() - tempoInicio) < (tempoLimite * 1000)) {
             int p1 = random.nextInt(10) + 1; // números aleatórios de 1 a 10
    ...
    public static void main(String[] args) {
        ...
        while (menu == 's') {
            ...
            if (erroFatal == false) {
                ...
                if (erroFatal == false) { //continua se o home não crashar
                    ...
                    if (opcao == 1) {
                        ...
                        while (repetir == 's') {
                            ...
                            if (erroFatal == false) repetir = repetirExercicio(); // Escolha de repetição
                            else break;
                        }
                    }
